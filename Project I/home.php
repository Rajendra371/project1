...
<body>
    <div class="container">
        <h2 class="text-center text-success">Hello <?php echo $_SESSION['username']; ?> Welcome to Fully Quiz Section</h2>
        ...
        <div class="container d-flex mt-4">
            <div class="card" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary " onclick="window.location.assign('bcaMenu.html')">PLAY QUIZ</a>
                </div>
            </div>
        </div>
</body>
